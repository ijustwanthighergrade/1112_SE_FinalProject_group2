...
class Sp (models.Model):
    ...
    Sp_store=models.CharField('店家id S+001',max_length=4,null=False)
...
class Cus (models.Model):
    ...
    product_past=models.CharField('產品id P+001',max_length=4,null=True,blank=True)
...
class storeboard (models.Model):
    ...
    store_id=models.CharField('店家id S+001',max_length=4,null=True, blank=True)
...
class order (models.Model):
    ...
    Sp_id=models.CharField('業務員ID(PK)/Sp001',max_length=5,null=False)
    Cus_id=models.CharField('客戶編號 c+14日期時間+random(3)',max_length=18,null=True, blank=True)

#產品販售詳細資料表
class order_detailed (models.Model):
    order_id=models.CharField('訂單編號 order+14+random(3)',max_length=22,null=False)
    product_id=models.CharField('產品id P+001',max_length=4,null=False)
...
class Marketing (models.Model):
    ...
    Marketing_clerk=models.CharField('業務員ID(PK)/Sp001',max_length=5,null=False)
    Marketing_client=models.CharField('客戶編號 c+14日期時間+random(3)',max_length=18,null=False)
...
class record (models.Model):
    Cus_id=models.CharField('客戶編號 c+14日期時間+random(3)',max_length=18,null=False)
    Marketing_id=models.CharField('編號(M+14date+0001)',max_length=19,null=False)
...
class Chair (models.Model):
    ...
    Chair_place=models.CharField('店家id S+001',max_length=4,null=False)
    ...
    Chair_pid=models.CharField('產品id P+001',max_length=4,null=False,) 

#按摩椅使用狀況資料表
class Cu (models.Model):
    Cu_exID=models.CharField('編號(U+date+001)',max_length=18,null=False,unique=True,primary_key=True)
    Cu_id=models.CharField('編號 C001',max_length=4,null=False,unique=True)
    Cu_userid=models.CharField('客戶編號 c+14日期時間+random(3)',max_length=18,null=False)
...
class Cou (models.Model):
    ...
    Cp_ID=models.CharField('進貨批號 CP+14日期時間+random(3)',max_length=19,null=True, blank=True)    

#按摩卷交易資料表
class Trade (models.Model):
    Trade_id=models.CharField('交易編號 T+14日期時間+random(3)',max_length=18,null=False,unique=True,primary_key=True)
    Cus_id=models.CharField('客戶編號 c+14日期時間+random(3)',max_length=18,null=False)      
    Voucher_id=models.CharField('按摩券編號/Cou00001',max_length=8,null=False) 
...
class Referrer (models.Model):
    Referrer_ID=models.CharField('客戶編號 c+14日期時間+random(3)',max_length=18,null=False)      
    Bref_id=models.CharField('客戶編號 c+14日期時間+random(3)',max_length=18,null=False) 
...
class cost (models.Model):
    store_id=models.CharField('店家id S+001',max_length=4,null=False)      
...
class feedback (models.Model):
    ...
    feedbackCu_id=models.CharField('編號 C001',max_length=4,null=False,default=0)    
    feedcus_id=models.CharField('客戶編號 c+14日期時間+random(3)',max_length=18,null=False,default=0)      
...
class need (models.Model):
    ...
    demand_id=models.CharField('需求類型ID(n+0001)',max_length=5,null=False)    
...
class arrange (models.Model):
    ...
    Ab_Sp=models.CharField('業務員ID(PK)/Sp001',max_length=5,null=False)    
...
class manage (models.Model):
    ...
    manage_category=models.CharField('失敗因素編號(fa+001)',max_length=5,null=True, blank=True)      
    manage_detail=models.TextField('失敗原因詳述',null=True, blank=True) 
    manage_frequency=models.IntegerField('聯絡次數',null=False,default=0)
    Sp_id=models.CharField('業務員ID(PK)/Sp001',max_length=5,null=False)    
    store_id=models.CharField('店家id S+001',max_length=4,null=False)    
